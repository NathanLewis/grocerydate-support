...
This repository contains documentation only — it is not the app's source code,
and it is published here solely to host the pages above. The text is not
licensed for reuse.
